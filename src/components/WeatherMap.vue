...
$color-gold: #b99362;
$color-brightgold: rgba(241, 215, 67, 0.938);
* {
...
path {
  stroke: #333;
  fill: transparent; // PATH顏色不能是none
  transition: 0.7s;
  cursor: pointer;
  &:hover {
    fill: $color-gold;
